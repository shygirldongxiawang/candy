...
public class GenericFederate {
    ...
    private GenericFederateAmbassador fedamb;
    ...
    public boolean                    stillJoined  = true;

    public GenericFederate(String federateName, String federationName, String fomFilePath, String readyToRun, GenericFederateAmbassador fedamb,
        ...
        GenericFederate.READY_TO_RUN = readyToRun;
    }
