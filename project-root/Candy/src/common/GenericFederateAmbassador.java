 ...
 * information.
 */
public class GenericFederateAmbassador extends NullFederateAmbassador {
    ...
    public GenericFederateAmbassador() {
    }
    ...
    private void log(String message) {
        System.out.println("GenericFederateAmbassador: " + message);
    }
