...
public class GamePlayer extends BaseGameCharacter {
    ...
    public void drawItself(Graphics g) {
        ...
        if (this.getMode() != GOD) {
            drawVisibilityRange(g, FedConfig.getPlayerDimension());
        }
        ...
        drawCandyAmount(g, FedConfig.getPlayerDimension());
    }

    public boolean isVisible(CCoordinate externalItem, CDimension callerDimension, CDimension calleeDimension) {
        if (this.mode == GamePlayer.GOD) {
            return true;
        }
        return super.isVisible(externalItem, callerDimension, calleeDimension);
    }
