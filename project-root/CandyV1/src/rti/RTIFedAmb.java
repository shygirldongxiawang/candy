...
public class RTIFedAmb extends NullFederateAmbassador {
    ...
    public void receiveInteraction(int interactionClass, ReceivedInteraction theInteraction, byte[] tag, LogicalTime theTime,
        ...
        try {
            helper.interactionReceived(interactionClass, theInteraction, tag, theTime, eventRetractionHandle);
        } catch (RTIexception | NumberFormatException | FederateInternalError e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
    }
