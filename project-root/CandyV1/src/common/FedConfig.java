...
public class FedConfig {
    ...
    private final static Color      VISIBILITY_RANGE_COLOR      = new Color(184, 138, 0);

    // Map properties
    private final static CDimension MAP_DIMENSION               = new CDimension(900, 900);
    private final static int        MAP_AVATAR_NUM              = 5000;
    private final static int        MAP_HOUSE_NUM               = 1000;
    ...
    private final static String     PLAYER_INTERACTION_TAG      = "InteractionRoot.PlayerUpdate";
    private final static double     PLAYER_VISIBILITY_RANGE     = 40;
    private final static CDimension PLAYER_DIMENSION            = new CDimension(40, 40);
    ...
    private final static int        HOUSE_TRANSFER_RATE         = 1;
    private final static int        HOUSE_VISIBIlITY_RANGE      = 50;
    private final static int        HOUSE_RELOAD_INTERVAL       = 999;
    private final static CDimension HOUSE_DIMENSION             = new CDimension(50, 50);
    private final static Color      HOUSE_COLOR                 = new Color(179, 0, 45);

    // Avatar properties
    private final static String     AVATAR_FED_TAG              = "ObjectRoot.Avatar";
    private final static double     AVATAR_VISIBILITY_RANGE     = 40;
    private final static CDimension AVATAR_DIMENSION            = new CDimension(40, 40);
    ...
    public static String getPlayerInteractionTag() {
        return PLAYER_INTERACTION_TAG;
    }

    public static Color getVisibilityRangeColor() {
        return VISIBILITY_RANGE_COLOR;
    }

    public static boolean isJoinHouse() {
        return JOIN_HOUSE;
    }

    public static boolean isJoinAvatar() {
        return JOIN_AVATAR;
    }

    public static boolean isJoinPlayer() {
        return JOIN_PLAYER;
    }
