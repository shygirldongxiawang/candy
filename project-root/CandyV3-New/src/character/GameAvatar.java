...
public class GameAvatar extends BaseGameCharacter {
    ...
    protected int         RandomMoveTime       = 0;
    ...
    public void move() {
        ...
        while (!judge) {
            if ((max_dis = (Math.sqrt(Math.pow(border_x - curr_x, 2) + Math.pow(border_y - curr_y, 2)))) < this.visibilityRange) {
        ...
        this.coordinate.setX(this.coordinate.getX() + this.MoveIncrement.getX());
        this.coordinate.setY(this.coordinate.getY() + this.MoveIncrement.getY());
